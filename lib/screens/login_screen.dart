...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Bọc trong SingleChildScrollView + bỏ Spacer (Spacer cần chiều cao
      // "bounded" nên khi bàn phím hiện lên làm khoảng trống bị co lại,
      // Column tràn ra ngoài -> Flutter vẽ vệt sọc vàng-đen báo lỗi overflow).
      // Dùng SizedBox cố định thay Spacer để không phụ thuộc bàn phím.
      body: SafeArea(
        child: LayoutBuilder(
