...
// CẬP NHẬT: Sửa lại điều hướng nút X và Done để quay về màn hình
// thanh toán (Ảnh B) thay vì bị đẩy về trang Login.
// ===================================================================
    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          ...
          // Sửa ở đây: dùng pop để quay lại màn hình trước đó (màn hình thanh toán ở Ảnh B)
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (isSuccess)
              ElevatedButton(
                // Sửa ở đây: Bấm nút Done cũng sẽ quay lại màn hình thanh toán (Ảnh B)
                onPressed: () => Navigator.pop(context),
