...
// TASK GỐC (14/08/2026):
//   "Dựng giao diện màn hình truyền thẻ, kết quả giao dịch" (phần 1/2:
//   màn hình truyền thẻ — phần kết quả xem transaction_result_screen.dart)
//
// MÔ TẢ:
//   Hiển thị thẻ đang active, nút "Confirm Payment" gọi PosTransferService
//   (của Phạm Tuân) để gửi thẻ tới đầu thu, rồi điều hướng sang màn hình
//   kết quả giao dịch.
// ===================================================================
...
class _NfcPaymentScreenState extends State<NfcPaymentScreen> {
  ...
  void _startPayment(CardModel card) {
    // Phạm Tuân (16-17/08): chặn giao dịch nếu thẻ đã hết hạn.
    ...
    _posService
      ...
      switch (event.stage) {
        ...
        case PosTransferStage.failed:
          // Huỳnh Phúc Điền (15-16/08): xử lý phản hồi từ đầu thu + lưu lịch sử.
