...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildQuickActions() {
    return Row(
      children: [
        // Nếu đã có thẻ active, ưu tiên đi thẳng vào NFC Payment;
        // nếu chưa có thẻ nào thì mở luồng quét để thêm thẻ trước.
        Expanded(
  ...
  void _handleScanResult(NfcEvent event) {
    if (event.state == NfcSessionState.tagDetected) {
      ...
      _showErrorDialog(NfcReadException(event.errorMessage ?? 'unknown'));
    }
  }
